                  ...
                  <div className="prose prose-invert prose-slate max-w-none">
                    <ReactMarkdown
                      components={{
                        ...
                        ul: ({ children }) => (
                          <ul className="list-disc pl-6 mb-3 text-slate-300">{children}</ul>
                        ),
                        ol: ({ children }) => (
                          <ol className="list-decimal pl-6 mb-3 text-slate-300">{children}</ol>
                        ),
                        li: ({ children }) => <li className="mb-1">{children}</li>,
                        code: ({ children }) => (
                          <code className="bg-slate-800 px-2 py-1 rounded text-blue-300 text-sm">
                            {children}
                          </code>
                        ),
                        pre: ({ children }) => (
