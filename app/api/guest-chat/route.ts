...
export async function POST(req: Request) {
  try {
    ...
    const guestContext = {
      ...
      content:
        'guest preview mode: keep answers concise, no personal data or memory, feedback/KB submissions allowed and attributed as guest.',
    }
    ...
    const providerClient = rateLimitedAI.openai
    ...
    const startStream = async () => {
      const streamResult = await providerClient.streamText(streamOptions, guestUserId, {
