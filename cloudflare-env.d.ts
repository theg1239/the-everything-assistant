/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2d038a3fd8c6166bb10eef5b414ca170)
...
declare namespace Cloudflare {
	interface Env {
		...
		USER_RATE_LIMITING_ENABLED: string;
		DATABASE_URL2: string;
		NEXT_PUBLIC_BASE_URL: string;
		API_RATE_LIMIT_REQUESTS_PER_MINUTE: string;
		API_RATE_LIMIT_REQUESTS_PER_HOUR: string;
		API_RATE_LIMIT_REQUESTS_PER_DAY: string;
		API_RETRY_MAX_RETRIES: string;
		API_RETRY_BACKOFF_MULTIPLIER: string;
		API_RETRY_MAX_BACKOFF_MS: string;
		...
		PAPERS_SERVICE_URL: string;
		NEXT_PUBLIC_VAPID_PUBLIC_KEY: string;
		VAPID_PRIVATE_KEY: string;
		VAPID_EMAIL: string;
		RUNPOD_API_KEY: string;
		RUNPOD_BASE_URL: string;
		COCKROACH_PASS: string;
		...
		R2_ENDPOINT: string;
		REDDIT_SCRAPER_URL: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		WORKER_SELF_REFERENCE: Fetcher /* the-everything-assistant */;
		ASSETS: Fetcher;
	}
}
