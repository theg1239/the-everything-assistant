  ...
  return (
    <div className="rounded-lg bg-black/20 backdrop-blur-sm border border-border/30 p-6">
      <div className="flex flex-col space-y-1.5 mb-6">
        ...
        <div className="text-sm text-muted-foreground lowercase">overall system status and configuration validation</div>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="flex items-center gap-3 p-3 rounded-lg bg-black/20 border border-border/20">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs md:text-sm text-muted-foreground">{data.environment.summary.apiKeys.totalAvailable}/{data.configuration.apiKeys.keyCount} available</p>
          </div>
        </div>
        <div className="flex items-center gap-3 p-3 rounded-lg bg-black/20 border border-border/20">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs md:text-sm text-muted-foreground">{data.environment.validation.isValid ? 'Valid' : 'Issues Found'}</p>
          </div>
        </div>
        <div className="flex items-center gap-3 p-3 rounded-lg bg-black/20 border border-border/20">
