...
export function ToolCallDisplay({ toolCalls }: ToolCallDisplayProps) {
  ...
  const allCompleted = toolCalls.every(
    toolCall => toolCall.state === 'result' || toolCall.result !== undefined
  )
          ...
          <div className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                <div className="text-sm font-medium text-foreground">Searching for data...</div>
        ...
        <div className="relative h-full flex flex-col">
          <div className="flex items-center justify-between p-6 border-b border-slate-700/40 rounded-t-3xl">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-light gradient-text">Tool Results</h2>
                <div className="flex items-center space-x-3 mt-2">
                  ...
                  <span className="text-xs text-slate-400">Expand to view detailed results</span>
                </div>
              </div>
            </div>
            <Button
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-medium gradient-text capitalize">
                          {toolCall.toolName?.replace(/([A-Z])/g, ' $1').toLowerCase() ||
                            'Tool Execution'}
                        </h3>
  ...
  return (
    <>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1">
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-8 w-8 p-0 text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg transition-all duration-200"
      ...
      {fullView &&
        ...
        createPortal(<FullViewModal />, document.body)}
    </>
  )
}
